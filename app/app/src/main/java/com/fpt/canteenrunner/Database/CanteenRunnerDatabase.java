...
@Database(entities = {AccountEntity.class, CanteenEntity.class, FoodsEntity.class, TicketEntity.class, MyTicketEntity.class, CategoriesEntity.class}, version = 1, exportSchema = false)
